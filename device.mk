...
# Include sony as optional package
$(call inherit-product-if-exists, hardware/sony/configs.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/lm/GameOptimizationFeature.xml:$(TARGET_COPY_OUT_VENDOR)/etc/lm/GameOptimizationFeature.xml \
